...
-- Create table for exercise types and their calorie burn rates (M-- Create workouts table for MacroMind fitness tracking application
CREATE TABLE workouts (
    workout_id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    exercise_name VARCHAR(100) NOT NULL,
...
('Tennis', 'sports', 7.3, 'Playing tennis, singles'),
('Soccer', 'sports', 10.0, 'Playing soccer, competitive'),
('Martial Arts', 'sports', 10.3, 'Martial arts training');-- Create table for exercise types and their calorie burn rates (MET values)
CREATE TABLE exercise_types (
    exercise_type_id INT AUTO_INCREMENT PRIMARY KEY,
    exercise_name VARCHAR(100) NOT NULL UNIQUE,
    category VARCHAR(50) NOT NULL, -- 'cardio', 'strength', 'flexibility', 'sports'
